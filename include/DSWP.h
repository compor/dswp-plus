...
private:
  ...
  set<Function *>
      generated; // all generated function that should not be run in the pass
  ...
  // give each instruction a name, including terminator instructions (which can
  // not be setName)
